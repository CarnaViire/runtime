...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class HttpClientBuilderExtensions
    {
        ...
        public static IHttpClientBuilder ConfigureHttpClient(this IHttpClientBuilder builder, Action<HttpClient> configureClient)
        {
            ...
            builder.Services.ConfigureHttpClientFactoryOptions(builder.Name, options => options.HttpClientActions.Add(configureClient));
        ...
        public static IHttpClientBuilder SetHandlerLifetime(this IHttpClientBuilder builder, TimeSpan handlerLifetime)
        {
            ...
            builder.Services.ConfigureHttpClientFactoryOptions(builder.Name, options => options.HandlerLifetime = handlerLifetime);
            return builder;
        }
